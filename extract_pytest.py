...
from extract import points_in_bbox
...
def test_points_in_bbox():
    ...
    radar_points = np.array([[1,1,1], [9, 8, 7], [1, 11, 0], [-1, 1, 1], [0, 0, 0], [10, 10, 10], [1, 1, -1]])
    
    inside_points_res = points_in_bbox(radar_points=radar_points, bbox=bbox)
    inside_points_expected = np.array([[1,1,1], [9, 8, 7], [0, 0, 0], [10, 10, 10], [1, 1, -1]])
